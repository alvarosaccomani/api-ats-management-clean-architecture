    ...
    public async getPeriods(usr_uuid: string, crd_uuid: string) {
        try {
            ...
            return periods.map(period => ({
                ...
                per_startdate: TimezoneConverter.toIsoStringInTimezone(period.per_startdate, 'America/Buenos_Aires'),
                per_enddate: TimezoneConverter.toIsoStringInTimezone(period.per_enddate, 'America/Buenos_Aires'),
                per_duedate: TimezoneConverter.toIsoStringInTimezone(period.per_duedate, 'America/Buenos_Aires'),
